...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 bg-gray-50 p-6">
        ...
        <div class="bg-white p-6 rounded shadow-md w-full lg:max-w-7xl mx-auto">
            <h2 class="text-2xl font-semibold mb-6 text-center">Edit Kategori</h2>
            <form action="{{ route('superadmin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 flex items-center space-x-6">
                    ...
                    <input type="file" id="icon" name="icon" accept="image/*"
                        class="border border-gray-300 rounded px-4 py-3 focus:outline-none focus:ring focus:border-blue-300">
                </div>
